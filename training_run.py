...
SAVE_DIRECTORY = "~/dli/data/denoiser/training_result"

# Configuration of training image files
# TRAIN_DIRECTORY contains three subdirectories:~/dli/data/denoiser/training_result
# rgb
...
TRAIN_DIRECTORY  = '~/dli/data/denoiser/training_data'
...
def printProgress(iteration, total, prefix = '', suffix = '', decimals = 1, barLength = 100):
    ...
    bar = chr(0x78) * filledLength + '-' * (barLength - filledLength)
